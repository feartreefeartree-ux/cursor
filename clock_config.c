...
/*
 * S32K144W BOARD_BootClockRUN  (s32sdk_s32k1xx_rtm_402)
 *
 * SOSC 8 MHz XTAL -> SPLL 160 MHz (PREDIV=1, MULT=40)
 * RUN RCCR: SCS=SPLL, DIVCORE=/2, DIVBUS=/2, DIVSLOW=/4
 *   CORE/SYS = 80 MHz
 *   BUS      = 40 MHz
 *   FLASH    = 20 MHz   (S32K14xW FLASH max is 20 MHz; do not use /3)
 *
 * FTM0-3  PCC = SPLLDIV1 = 80 MHz   (was SIRCDIV1 8 MHz)
 * ADC0/1  PCC = SPLLDIV2 = 40 MHz   (was SIRCDIV2 8 MHz)
 * PDB     bus clock      = 40 MHz   (was 48 MHz; PCC clkSrc stays OFF)
 * FlexCAN PCC clkSrc stays OFF (engine clock is CTRL1[CLKSRC]: SOSC or SYS)
 * LPIT0   left as SIRCDIV2; lpit_timer_init() programs PCC itself
 *
 * If FTM MOD / deadtime are constants from the old 8 MHz clock, update them:
 *   edge-aligned:    MOD = ftm_hz / fpwm - 1
 *   center-aligned:  MOD = ftm_hz / (2 * fpwm) - 1
 *   deadtime ticks scale with FTM clock (8 MHz -> 80 MHz is 10x)
 * PDB delay ticks scale with BUS (48 MHz -> 40 MHz).
 */
...
- {id: ADC1_CLK.outFreq, value: 40 MHz}
...
- {id: DMA0_CLK.outFreq, value: 40 MHz}
...
- {id: FLEXCAN0_CLK.outFreq, value: 40 MHz}
- {id: FLEXCAN1_CLK.outFreq, value: 40 MHz}
- {id: FTFM0_CLK.outFreq, value: 20 MHz}
- {id: FTM0_CLK.outFreq, value: 80 MHz}
- {id: FTM1_CLK.outFreq, value: 80 MHz}
- {id: FTM2_CLK.outFreq, value: 80 MHz}
- {id: FTM3_CLK.outFreq, value: 80 MHz}
...
- {id: MPU0_CLK.outFreq, value: 40 MHz}
- {id: MSCM0_CLK.outFreq, value: 40 MHz}
- {id: PDB0_CLK.outFreq, value: 40 MHz}
- {id: PDB1_CLK.outFreq, value: 40 MHz}
...
- {id: 'RUN:SCG.SCSSEL.sel', value: SCG.SPLL}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    .scgConfig =
    {
        ...
        .clockModeConfig =
        {
            ...
            .rccrConfig =
            {
                .src = SCG_SYSTEM_CLOCK_SRC_SYS_PLL,/* System PLL: 160 MHz / 2 = 80 MHz CORE */
                ...
                .divSlow = SCG_SYSTEM_CLOCK_DIV_BY_4,/* Slow Clock Divider: divided by 4 -> FLASH 20 MHz */
            },
            .vccrConfig =
            {
